...
| # | Задача | Статус | Комментарий |
|:---|:---|:---:|:---|
| 7.1 | Реализовать компонент `ArtifactPanel` (правая панель) | ✅ | Toolbar, табы, download/open, версия, 17 тестов |
| 7.2 | Реализовать `MarkdownViewer` (просмотр structure.md) | ✅ | react-markdown + remark-gfm + rehype-highlight, 13 тестов |
| 7.3 | Реализовать `SlidePreview` (превью HTML-слайдов) | ✅ | iframe + srcdoc, ResizeObserver, scale 1920×1080, 14 тестов |
