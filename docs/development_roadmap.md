...
| 8.5 | Integration-тесты: редактирование → перегенерация | ✅ | 13 integration-тестов: WS handler + EngineBridge + E2E cycle, 2026-02-23 |
| 8.6 | Обновить README.md и CHANGELOG.md | ✅ | README: +4 компонента, WS протокол; CHANGELOG: v0.9.0, 2026-02-23 |
