...
AI Presentation Generator — это full-stack веб-приложение, которое превращает текстовое описание темы в полноценную HTML-презентацию. Система использует **17-этапный мультиагентный пайплайн** (16 AI-агентов + финальная сборка), работающих последовательно и параллельно, для создания структуры, контента, дизайна и визуализации данных.
...
| AI-агенты | 17 этапов пайплайна (16 агентов + Assembly) |
...
- Мультиагентный AI-пайплайн с 17 этапами (16 агентов + Assembly)
