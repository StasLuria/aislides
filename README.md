...
| `ocean_deep` | Ocean Deep | Nature | Глубокий океанический синий |
...
| `citrus_energy` | Citrus Energy | Creative | Энергичный цитрусовый |
...
- Обложка презентации (первый слайд) в чате с переходом в Viewer по клику
...
| Routes (API) | ~11 200 | 22 |
| Server (прочее) | ~3 500 | 13 |
| Client (страницы) | ~7 500 | 9 |
| Client (компоненты) | ~7 400 | 52 |
| Shared | ~100 | 4 |
| Тесты | ~21 400 | 62 |
| **Итого** | **~67 100** | **176** |
...
```bash
pnpm test              # Запуск всех тестов (1567 тестов)
