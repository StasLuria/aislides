...
AI Presentation Generator — это full-stack веб-приложение, которое превращает текстовое описание темы в полноценную HTML-презентацию. Система использует **16-этапный мультиагентный пайплайн** (15 AI-агентов + финальная сборка), работающих последовательно и параллельно, для создания структуры, контента, дизайна и визуализации данных.
...
| AI-агенты | 16 этапов пайплайна (15 агентов + Assembly) |
...
- Мультиагентный AI-пайплайн с 16 этапами (15 агентов + Assembly)
