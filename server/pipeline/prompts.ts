...
Правила бизнес-копирайтинга для заголовков и структуры:
- Заголовок-вывод: Каждый заголовок слайда содержит ГЛАВНУЮ МЫСЛЬ, а не просто тему. Не «Результаты», а «Выручка выросла на 40% за квартал».
- Один слайд — одна мысль: Если идей две, разделите на два слайда.
- Фокус на результат: Каждый слайд отвечает на вопрос «и что?». Выгоды для аудитории, а не процессы.
- Конкретика в key_points: «Рост на 25%» вместо «значительный рост». «67% клиентов» вместо «многие клиенты».
- Логика повествования: Каждый следующий слайд отвечает на вопрос, возникший после предыдущего.
</copywriting_guidelines>
<output_format>
...
**ОСНОВНЫЕ ПРИНЦИПЫ:**
1. Простота и ясность: Избегайте сложных терминов, иностранных слов и длинных предложений. Цель — быть понятым с первого раза.
2. Фокус на результат: Каждое утверждение отвечает на вопрос «и что?». Говорите о выгодах для аудитории, а не о процессах. Не «мы внедрили новую систему», а «теперь обработка заказов занимает 2 часа вместо 8».
3. Доказательность: Подкрепляйте слова фактами, цифрами и конкретными примерами. Один конкретный пример стоит десяти общих утверждений.
4. Один слайд — одна мысль: Не перегружайте слайды информацией. Если на слайде две идеи, разделите его на два слайда.

**ФРЕЙМВОРКИ ДЛЯ СТРУКТУРЫ ПОВЕСТВОВАНИЯ:**
- PAS (Problem → Agitate → Solution): Когда нужно показать, как решение устраняет проблему. Сначала называем проблему, показываем последствия, предлагаем решение с измеримым результатом.
- BAB (Before → After → Bridge): Когда нужно продемонстрировать трансформацию. Показываем текущую ситуацию, желаемый результат, и как туда попасть.
- FAB (Features → Advantages → Benefits): Когда нужно перевести технические детали на язык пользы. Начинаем с того что есть, чем это лучше, что получит пользователь.
- 4Ps (Picture → Promise → Proof → Push): Когда нужно построить убедительную историю. Рисуем картину будущего, даём обещание, подкрепляем фактами, завершаем призывом к действию.

**ПРАВИЛА ЯЗЫКА:**
- Активный залог: «Мы сделали» вместо «было сделано».
- Простые слова: «Улучшить» вместо «оптимизировать», «Сделать» вместо «осуществить», «Внедрить» вместо «имплементировать».
- Короткие предложения: 15-20 слов. Одна мысль — одно предложение.
- Конкретика: «Рост на 25%» вместо «значительный рост», «В течение двух недель» вместо «в ближайшее время», «67% клиентов» вместо «многие клиенты».
- Без канцелярита: Избегайте конструкций «в целях», «в рамках», «по итогам проведённого анализа».
- Без иностранных слов: «Пример» вместо «кейс», «Вывод» вместо «инсайт», «Задача» вместо «челлендж».
- Убирайте лишнее: Каждое слово должно работать. Уберите вводные «как известно», «следует отметить».

**СТРУКТУРА СЛАЙДА:**
- Заголовок-вывод: Заголовок содержит главную мысль слайда, а не просто тему. Не «Результаты исследования», а «70% клиентов готовы платить больше за качество».
- Минимум текста: Текст поддерживает визуал, а не заменяет его.
- Логика изложения: Каждый следующий слайд отвечает на вопрос, возникший после предыдущего.

**РАБОТА С ДОКАЗАТЕЛЬСТВАМИ:**
- Конкретные цифры: «2,3 млн рублей» вместо «увеличили продажи».
- Сравнения: «Было — стало», «мы — конкуренты», «до — после».
- Примеры: Называйте компании, проекты, имена.
- Визуализация: График лучше таблицы, таблица лучше текста.
- Превращайте данные в истории: Не «рост на 30%», а «каждый третий клиент стал покупать больше».

**АДАПТАЦИЯ ПОД АУДИТОРИЮ:**
- Для руководителей: стратегия и цифры.
- Для специалистов: методы и инструменты.
- Для клиентов: выгоды и гарантии.
</copywriting_style>
