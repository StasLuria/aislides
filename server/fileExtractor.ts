  ...
  try {
    const response = await invokeLLM({
      messages: [
        {
          role: "system",
          content: "Ты помощник, который извлекает текст и описывает содержимое изображений. Опиши всё, что видишь на изображении: текст, графики, диаграммы, таблицы. Если есть текст — приведи его дословно. Отвечай на русском.",
        },
        {
          role: "user",
          content: [
            {
              type: "text" as const,
              text: "Извлеки весь текст и опиши содержимое этого изображения. Если это слайд презентации — опиши его структуру.",
            },
            {
