/**
 * Quality Testing Script — Round 2: runs 4 remaining test cases
 */
...
async function main() {
  console.log("╔══════════════════════════════════════════════════════════════════════╗");
  console.log("║           QUALITY TESTING — Round 2 (4 remaining tests)             ║");
  console.log("╚══════════════════════════════════════════════════════════════════════╝");
  ...
  const outputPath = "/home/ubuntu/presentation-frontend/scripts/quality_results_r2.json";
